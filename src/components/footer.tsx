...
const Footer = () => {
    ...
    return (
        <section className="bg-[#F6F4F4] pt-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="flex flex-wrap gap-5 pt-3">
                            <div className="flex flex-col gap-2">
                                {quickLinks1.map((link, index) => (
                                    <Link key={index} href={link.href} className="text-normal text-[#6B6B6B] font-light hover:underline">
                                        {link.label}
                                    </Link>
                                ))}
                            </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-2 pt-3">
                            <span className="text-normal text-[#6B6B6B] font-light">
                                Location - Willing Resort
                                <br />
                                Yueling Village, Nubee Geog, Trongsa Bhutan
                            </span>
                            <Link href="tel:+97517166888" className="text-normal text-[#6B6B6B] font-light hover:underline">
                                Phone - +975 17166888 OR +975 77166888
                            </Link>
                            <Link href="tel:+97517346988" className="text-normal text-[#6B6B6B] font-light hover:underline">
                                For Willing Waterfall Cafe - +975 17346988
                            </Link>
                            <Link href="mailto:willingbhutan@gmail.com" className="text-normal text-[#6B6B6B] font-light hover:underline">
                            ...
                            <Link
                                ...
                                className="text-normal text-[#6B6B6B] font-light hover:underline"
                            >
            ...
            <div className="text-center text-normal bg-background py-5 mt-10  font-light">
