  ...
  return (
    <div>
      ...
      <div className='mt-6 sm:mt-[100px]'>
        <FeatureSection
          title="Scenic Suite Stay"
          imagePosition='left'
          description={`
                  Escape to Willing Resort, where Bhutanese design meets modern comfort. Choose from 
                  three suites: Junior Suite, with mountain views; Deluxe Suite, featuring a balcony 
                  and soaking tub; or Luxury Cottage, offering a fireplace, spacious living, and breathtaking 
                  panoramas
                        `}
      ...
      <div className='mt-6 sm:mt-[100px]'>
        <FeatureSection
          title="Authentic Bhutanese Dining"
          imagePosition='right'
          description={`
                    Experience a delightful culinary journey at Willing Resort, where Bhutanese 
                    flavors blend with international cuisine. Enjoy stunning valley views while 
                    savoring signature dishes like our Blueberry Cake, made from wild local berries. 
                    Fresh, farm-to-table ingredients and cozy ambiance await.
                        `}
      ...
      <div className='mt-6 sm:mt-[100px]'>
        <FeatureSection
          ...
          imagePosition='left'
          description={`
                          Embark on trails with stunning views, such as Singye Thang from Dorji Goenba, 
                          and experience the breathtaking beauty of Gangkar Phunsum and Semjee Village. 
                          Immerse yourself in the serene landscapes, captivating mountain vistas, and the 
                          tranquil charm of these picturesque destinations, offering a perfect escape into 
                          nature's splendor.
                        `}
